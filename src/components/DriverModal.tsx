...
import { X, User, Bike, CreditCard, Image as ImageIcon, Save, Loader2 } from 'lucide-react';
...
export default function DriverModal({ isOpen, onClose, driver }: DriverModalProps) {
  ...
  useEffect(() => {
    if (driver) {
      ...
      setPlacaVehiculo(driver.placaVehiculo || '');
            ...
            <form onSubmit={handleSave} className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Placa</label>
                    <div className="relative">
                      <Bike className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                      <input
                        type="text"
